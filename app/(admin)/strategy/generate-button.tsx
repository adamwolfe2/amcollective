...
export function GenerateStrategyButton() {
  ...
  function handleGenerate() {
    startTransition(async () => {
      ...
      try {
        const res = await fetch("/api/admin/generate/strategy", { method: "POST" });
        ...
        setMessage(
          body.recommendationCount !== undefined
            ? `Done. ${body.recommendationCount} recommendations generated (health: ${body.healthScore ?? "??"}/100).`
