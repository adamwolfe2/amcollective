...
export default function EngagementsPayError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    captureError(error, { tags: { component: "EngagementsPayPage" } });
  }, [error]);

  return (
    <div className="border border-[#0A0A0A]/10 bg-white p-12 text-center">
      <h2 className="font-serif text-xl font-bold mb-2">Engagements failed to load</h2>
