...
export default function VenturePnLError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    captureError(error, { tags: { component: "VenturePnLPage" } });
  }, [error]);

  return (
    <div className="border border-[#0A0A0A]/10 bg-white p-12 text-center">
      <h2 className="font-serif text-xl font-bold mb-2">Venture P&amp;L failed to load</h2>
