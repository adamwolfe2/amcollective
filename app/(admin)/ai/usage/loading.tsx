export default function AiUsageLoading() {
  return (
    <div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="border border-[#0A0A0A]/10 p-4">
            ...
            <div className="h-8 w-20 bg-[#0A0A0A]/5 animate-pulse mb-1" />
      ...
      {/* Chart placeholder */}
      <div className="border border-[#0A0A0A]/10 p-4 mb-6" style={{ height: 200 }}>
        <div className="h-4 w-32 bg-[#0A0A0A]/5 animate-pulse mb-4" />
        <div className="h-full w-full bg-[#0A0A0A]/[0.02] animate-pulse" />
      </div>

      {/* Top runs table */}
      <div className="h-5 w-28 bg-[#0A0A0A]/5 animate-pulse mb-3" />
      <div className="border border-[#0A0A0A]/10">
        <div className="flex gap-4 px-4 py-3 border-b border-[#0A0A0A]/10 bg-[#0A0A0A]/[0.02]">
          {["Model", "Route", "Input", "Output", "Cost", "When"].map((_, i) => (
        ...
        {Array.from({ length: 8 }).map((_, i) => (
          <div key={i} className="flex gap-4 px-4 py-3 border-b border-[#0A0A0A]/5">
            ...
            <div className="h-4 w-12 bg-[#0A0A0A]/5 animate-pulse" />
            <div className="h-4 w-14 bg-[#0A0A0A]/5 animate-pulse" />
